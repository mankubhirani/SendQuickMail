...
@Component({
  selector: 'app-segment-main',
  templateUrl: './segment-main.component.html',
  styleUrls: ['./segment-main.component.css']
})
export class SegmentMainComponent implements OnInit {
  showFiller = false;
  userDetails: any;
  companyId: any;
  companydata: any;
